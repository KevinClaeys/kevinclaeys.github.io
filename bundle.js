...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appHeaderHeader = __webpack_require__(162);

	var _appHeaderHeader2 = _interopRequireDefault(_appHeaderHeader);

	var _appHomeHome = __webpack_require__(165);

	var _appHomeHome2 = _interopRequireDefault(_appHomeHome);

	var _appAboutAbout = __webpack_require__(1);

	var _appAboutAbout2 = _interopRequireDefault(_appAboutAbout);

	var _appContactContact = __webpack_require__(168);

	var _appContactContact2 = _interopRequireDefault(_appContactContact);

	var _appFooterFooter = __webpack_require__(171);
	...
	function main() {
	    ...
	    _react2['default'].render(_react2['default'].createElement(_appAboutAbout2['default'], null), document.getElementById('about'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aboutCss = __webpack_require__(2);
	    ...
	    _createClass(About, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { className: _aboutCss2['default'].description },
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'div',
	                            { className: _aboutCss2['default'].icon },
	                            _react2['default'].createElement('i', { className: 'icon-consultancy fa fa-share-alt' })
	                        ),
	                        _react2['default'].createElement(
	                            'h3',
	                            null,
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            'I provide front-end & web development consultancy to companies of all sizes.'
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            'div',
	                            { className: _aboutCss2['default'].icon },
	                            _react2['default'].createElement('i', { className: 'icon-healthcare fa fa-heartbeat' })
	                        ),
	                        _react2['default'].createElement(
	                            'h3',
	                            null,
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            'I build up several years of experience in the healthcare domain for both public and private organizations. With great insight of the flow organizations want. And by working on projects that use the Belgian eHealth platform.'
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            'div',
	                            { className: _aboutCss2['default'].icon },
	                            _react2['default'].createElement('i', { className: 'icon-development fa fa-code' })
	                        ),
	                        _react2['default'].createElement(
	                            'h3',
	                            null,
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            'I work on products and projects with great focus on performance, scalability and maintainability.'
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            'div',
	                            { className: _aboutCss2['default'].icon },
	                            _react2['default'].createElement('i', { className: 'icon-architecture fa fa-wrench' })
	                        ),
	                        _react2['default'].createElement(
	                            'h3',
	                            null,
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            'The workflow, design process and performance concerns tailored to your company, product and team.'
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.locals = {
	  "description": "_3d1tLXxXiE58kzG9ZDjB2b",
	  "icon": "_291R6EfL2iVygm1_y924gR"
	};
	exports.push([module.id, "._3d1tLXxXiE58kzG9ZDjB2b{\n    text-align: center;\n    padding: 40px 10px 10px 10px;\n}\n\n._3d1tLXxXiE58kzG9ZDjB2b p{\n    font-size: 14px;\n    color: #8e97a9;\n}\n\n._291R6EfL2iVygm1_y924gR{\n    padding-top: 20px;\n    width: 120px;\n    height: 120px;\n    border: 1px solid #e2e6eb;\n    border-radius: 30px;\n    background-color: white;\n    margin: 0 auto;\n    font-size: 60px;\n}\n\n.icon-consultancy, .icon-architecture{\n    color: #6585ed;\n}\n\n.icon-healthcare {\n    color: #f5756c;\n}\n\n.icon-development{\n    color: #5fd9ad;\n}\n", ""]);
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: '#about', className: _headerCss2['default'].about },
	                        'About'
	                    ),
	                    _react2['default'].createElement(
	                        'a',
	                        { href: '#blog', className: _headerCss2['default'].blog },
	                        'Blog'
	                    ),
	                    _react2['default'].createElement(
	                        'a',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeCss = __webpack_require__(166);
	...
	var Home = (function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: _homeCss2['default'].description },
	        _react2['default'].createElement(
	          'div',
	          { className: 'desc' },
	          _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'p',
	            null,
	            'Hi I\'m Kevin. I specialise in healthcare-based projects. With a great focus on performace, scalability and maintainability.'
	          ),
	          _react2['default'].createElement(
	            'p',
	            null,
	            'Here you will see me write and share my personal experiences about healthcare & development on the projects I do for my customers.'
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(4)();
	exports.locals = {
	  "description": "_3f_DmeCplR5kExg5aaqRav"
	};
	exports.push([module.id, "._3f_DmeCplR5kExg5aaqRav {\n    text-align: center;\n    padding-top: 40px;\n    padding-bottom: 40px;\n    color: white;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contactCss = __webpack_require__(169);
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            'Bovenrij 50 b101, 2200 Herentals'
	                        ),
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                    ...
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'col-lg-6 col-md-6 col-sm-12' },
	                        _react2['default'].createElement('iframe', { src: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2501.4036829586453!2d4.8377554!3d51.17478219999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c1523ceabe27b9%3A0x40385c21fd9df492!2sBovenrij+50%2C+2200+Herentals!5e0!3m2!1snl!2sbe!4v1437487908540', className: 'googleMaps', width: '100%', height: '430', frameborder: '0' })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _footerCss = __webpack_require__(172);
